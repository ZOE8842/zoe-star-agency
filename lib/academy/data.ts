...
export const CATEGORIES: Category[] = [
  {
    ...
    lessons: [
      ...
      },
      {
        ...
        title: "Reichweiten-Limit erkennen + vermeiden",
        summary:
          "Wie du merkst dass deine Reichweite gerade gedrosselt ist und wie du wieder rauskommst.",
        reading_minutes: 5,
        blocks: [
          { type: "lead", text: "TikTok nennt es nicht offiziell 'Shadowban' — der Begriff ist Community-Konsens. Was es aber gibt: Reichweiten-Drosselung, Account-Strikes, LIVE-Sperre. Du merkst es an stagnierender Reichweite, ploetzlich wenig neuen Zuschauern und tot wirkenden Streams." },
          { type: "callout", text: "Quellenlage: Die folgenden 3 Stufen sind aus Agency-Erfahrung beobachtet, nicht offiziell von TikTok dokumentiert. Zeitangaben sind Erfahrungswerte, im Einzelfall laenger oder kuerzer." },
          { type: "h2", text: "3 Stufen · aus Agency-Erfahrung" },
          { type: "ol", items: [
            "Soft-Limit (Erfahrungswert · meist 1-3 Tage): Reichweite faellt ab, Stream laeuft aber. Nicht offiziell von TikTok bestaetigt.",
            "LIVE-Sperre (offiziell · siehe Account Status im Creator Center): LIVE-Button verschwindet. Dauer variiert je nach Verstoss-Schwere.",
            "Account-Sperre (offiziell · Community Guidelines): kompletter Account betroffen. Loesung nur via TikTok-Support-Appeal.",
          ] },
          { type: "h2", text: "Was du sofort tust" },
          { type: "ul", items: [
            "Stream beenden",
            "App komplett schliessen, nicht im Hintergrund",
            "Erfahrungswert: 24h Pause helfen oft — keine Garantie",
            "Cache leeren (sicher schadlos)",
            "Account Status im Creator Center pruefen — das ist die offizielle Quelle",
            "ZOE 'Problem melden' fuer Diagnose",
          ] },
          { type: "callout", text: "Goldene Regel: das offizielle 'Account Status'-Dashboard im TikTok Creator Center ist die zuverlaessige Quelle. Alles andere sind Beobachtungen und Vermutungen aus der Creator-Community." },
        ],
      },
    ],
  },
