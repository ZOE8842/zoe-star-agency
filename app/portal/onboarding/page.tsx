  ...
  return (
    <OnboardingFlow
      ...
      i18n={{
        ...
        s3_subtitle_zero: t("onboarding.s3_subtitle_zero"),
        s3_subtitle_one: t("onboarding.s3_subtitle_one"),
        s3_subtitle_more: t("onboarding.s3_subtitle_more"),
        field_extra_focus_placeholder: t("onboarding.field_extra_focus_placeholder"),
        field_extra_focus_followup: t("onboarding.field_extra_focus_followup"),
        s4_subtitle: t("onboarding.s4_subtitle"),
        field_whatsapp: t("onboarding.field_whatsapp"),
        field_whatsapp_hint: t("onboarding.field_whatsapp_hint"),
        s4_disclaimer: t("onboarding.s4_disclaimer"),
        s5_subtitle: t("onboarding.s5_subtitle"),
        field_bio_hint: t("onboarding.field_bio_hint"),
        permissions_eyebrow: t("onboarding.permissions_eyebrow"),
        field_allow_showcase_label: t("onboarding.field_allow_showcase_label"),
        field_allow_showcase_desc: t("onboarding.field_allow_showcase_desc"),
        field_allow_partner_label: t("onboarding.field_allow_partner_label"),
        field_allow_partner_desc: t("onboarding.field_allow_partner_desc"),
        goal_community: t("onboarding.goal_community"),
        goal_ranking: t("onboarding.goal_ranking"),
        goal_brand_deals: t("onboarding.goal_brand_deals"),
