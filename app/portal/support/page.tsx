    ...
    <>
      ...
      <main className="container-luxe py-16">
        ...
        <h1 className="heading-display text-4xl md:text-5xl mb-4">
          Brauchst du <span className="text-champagne">Hilfe?</span>
        </h1>
        <p className="text-cream/60 text-sm mb-12">
          Ticket eroeffnen — Payout · Vertrag · Event · Technik · Traffic · Allgemein.
        </p>

        <TicketForm />

        <div className="mt-16 mb-6">
          <p className="eyebrow">Deine Tickets</p>
        </div>
        {(!tickets || tickets.length === 0) && (
          <div className="border border-champagne/15 p-10 text-center">
            <p className="text-cream/40 text-sm">Noch keine Tickets.</p>
          </div>
        )}
